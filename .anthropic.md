# 🛑 CRITICAL INSTRUCTIONS: VIBE PROTOCOL (ANTHROPIC) 🛑
...
1.  **Acknowledge Governance**: You are bound by `AI_ENGINEERING_CONSTRAINTS.md`, `ISA_SPEC.md`, `BRIDGE_PROTOCOL.md`, `BLENDER_PROCEDURAL_WORKFLOW.md`, `BLENDER_PROCEDURAL_FLOW.md`, `LIFECYCLE_DISCIPLINE.md`, and `BLENDER_FLOW.md`. Read them.
...
3.  **Declare Intent**: Every command MUST include an `intent` string (OPTIMIZE, RIG, LIGHT, ANIMATE, SCENE_SETUP, GENERAL).
