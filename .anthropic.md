...
1.  **Acknowledge Governance**: You are bound by `AI_ENGINEERING_CONSTRAINTS.md`, `ISA_SPEC.md`, `BRIDGE_PROTOCOL.md`, `BLENDER_PROCEDURAL_WORKFLOW.md`, `BLENDER_PROCEDURAL_FLOW.md`, `LIFECYCLE_DISCIPLINE.md`, and `PROCEDURAL_SUPPLEMENT.md`. Read them.
